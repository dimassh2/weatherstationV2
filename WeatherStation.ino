// =========================================================================
//            STASIUN CUACA ESP32 DENGAN WEB DASHBOARD -Final V2
// =========================================================================
// Fitur v5:
// - Respons buzzer instan saat hujan (pengecekan sensor setiap 500ms).
// - Lagu tema Mario Bros diperpanjang dan tempo dipercepat.
// - Logika non-blocking dipertahankan untuk pemutaran lagu.
// =========================================================================
...
const char* ssid = "NHK88.NET";
const char* password = "11123111";
const char* serverName = "http://192.168.1.241/weather_dashboard_php/receive_data.php";
...
// --- Interval Timing ---
const long SENSOR_READ_INTERVAL = 500; // Baca sensor setiap 500ms untuk respons cepat
...
// Variabel untuk logika buzzer cerdas
bool wasRaining = false; 
bool isPlayingTheme = false;
int currentNoteIndex = 0;
unsigned long noteStartTime = 0;

// --- Lagu Tema Super Mario Bros (Diperpanjang & Dipercepat) ---
int tempo = 120; // Durasi dasar, lebih kecil = lebih cepat
int marioMelody[] = {
...
// Durasi dalam milidetik, dihitung dari tempo
int marioDurations[] = {
...
void setup() {
  ...
  if (!bmp.begin(BMP280_ADDRESS)) {
    Serial.println(F("Tidak dapat menemukan sensor BMP280 di alamat 0x76!"));
    lcd.clear();
...
void readAllSensors() {
  ...
  // Hanya cetak ke serial jika ada perubahan kondisi untuk mengurangi spam
  static String lastPrintedCondition = "";
  if(condition != lastPrintedCondition) {
      Serial.println("Kondisi saat ini: " + condition);
      lastPrintedCondition = condition;
  }
}
...
void updateLCD() {
  ...
  Serial.println("LCD updated to screen " + String(lcdScreenState));
}
